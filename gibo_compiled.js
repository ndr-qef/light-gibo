...
lt.plugins.gibo.files.local_bos = (function local_bos(r){return cljs.core.sort_by.call(null,(function (p1__7902_SHARP_){return clojure.string.lower_case.call(null,lt.plugins.gibo.files.bo_name.call(null,p1__7902_SHARP_));
...
return (function (p1__7904_SHARP_){return global.call(null,p1__7904_SHARP_);
});})(global))
,cljs.core.filter.call(null,((function (global){
return (function (p1__7903_SHARP_){return lt.objs.files.dir_QMARK_.call(null,global.call(null,p1__7903_SHARP_));
});})(global))
,p)))));
});
...
return (function iter__7920(s__7921){return (new cljs.core.LazySeq(null,((function (opts__$1){
return (function (){var s__7921__$1 = s__7921;while(true){
var temp__4126__auto__ = cljs.core.seq.call(null,s__7921__$1);if(temp__4126__auto__)
{var s__7921__$2 = temp__4126__auto__;if(cljs.core.chunked_seq_QMARK_.call(null,s__7921__$2))
...
{var i = cljs.core._nth.call(null,c__7079__auto__,i__7922);cljs.core.chunk_append.call(null,b__7923,lt.objs.sidebar.command.item.call(null,this$,i));
{
var G__7924 = (i__7922 + 1);
i__7922 = G__7924;
continue;
}
} else
...
{var i = cljs.core.first.call(null,s__7921__$2);return cljs.core.cons.call(null,lt.objs.sidebar.command.item.call(null,this$,i),iter__7920.call(null,cljs.core.rest.call(null,s__7921__$2)));
}
} else
{return null;
}
...
lt.plugins.gibo.__BEH__on_exit = (function __BEH__on_exit(this$,data){var out = [cljs.core.str(data)].join('');var G__7869 = out;if(cljs.core._EQ_.call(null,"1",G__7869))
...
{if(cljs.core._EQ_.call(null,"0",G__7869))
...
__BEH__custom.cljs$lang$applyTo = (function (arglist__7870){
var this$ = cljs.core.first(arglist__7870);
var paths = cljs.core.rest(arglist__7870);
...
lt.plugins.gibo.__BEH__remove_BANG_ = (function __BEH__remove_BANG_(this$){var last_added_7871 = cljs.core.last.call(null,new cljs.core.Keyword(null,"bos","bos",1014001976).cljs$core$IFn$_invoke$arity$1(cljs.core.deref.call(null,this$)));lt.object.update_BANG_.call(null,this$,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"bos","bos",1014001976)], null),cljs.core.disj,last_added_7871);
return lt.object.raise.call(null,this$,new cljs.core.Keyword(null,"display-buffer","display-buffer",878107421));
});
...
if(!lt.util.load.provided_QMARK_('lt.plugins.gibo.git')) {
goog.provide('lt.plugins.gibo.git');
goog.require('cljs.core');
goog.require('lt.objs.notifos');
goog.require('lt.objs.proc');
goog.require('lt.objs.files');
...
goog.require('lt.objs.proc');
goog.require('lt.objs.files');
goog.require('lt.plugins.gibo');
goog.require('lt.plugins.gibo.files');
goog.require('lt.plugins.gibo');
goog.require('lt.objs.notifos');
goog.require('lt.plugins.gibo.files');
goog.require('lt.object');
lt.plugins.gibo.git.__BEH__on_out = (function __BEH__on_out(this$,data){var out = [cljs.core.str(data)].join('');return cljs.core.println.call(null,out);
});
lt.object.behavior_STAR_.call(null,new cljs.core.Keyword("lt.plugins.gibo.git","on-out","lt.plugins.gibo.git/on-out",3861953894),new cljs.core.Keyword(null,"triggers","triggers",2516997421),new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"proc.out","proc.out",4302083112),null], null), null),new cljs.core.Keyword(null,"reaction","reaction",4441361819),lt.plugins.gibo.git.__BEH__on_out);
lt.plugins.gibo.git.__BEH__on_exit = (function __BEH__on_exit(this$,data){var out = [cljs.core.str(data)].join('');var G__7908 = out;if(cljs.core._EQ_.call(null,"1",G__7908))
{lt.objs.notifos.done_working.call(null);
return lt.objs.notifos.set_msg_BANG_.call(null,"Git operation failed with exit code 1.",new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",1108647146),"error"], null));
} else
{if(cljs.core._EQ_.call(null,"0",G__7908))
{lt.objs.notifos.done_working.call(null,"Git operation successful; refreshing .gitignore boilerplates.");
return lt.object.raise.call(null,new cljs.core.Keyword(null,"selector","selector",2205476689).cljs$core$IFn$_invoke$arity$1(cljs.core.deref.call(null,lt.plugins.gibo.gibo)),new cljs.core.Keyword(null,"force-refresh!","force-refresh!",3989490874));
} else
{if(new cljs.core.Keyword(null,"else","else",1017020587))
...
lt.object.behavior_STAR_.call(null,new cljs.core.Keyword("lt.plugins.gibo.git","on-exit","lt.plugins.gibo.git/on-exit",1465271114),new cljs.core.Keyword(null,"triggers","triggers",2516997421),new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"proc.exit","proc.exit",4162906152),null], null), null),new cljs.core.Keyword(null,"reaction","reaction",4441361819),lt.plugins.gibo.git.__BEH__on_exit);
lt.plugins.gibo.git.__BEH__on_error = (function __BEH__on_error(this$,data){var out = [cljs.core.str(data)].join('');lt.objs.notifos.done_working.call(null);
lt.objs.notifos.set_msg_BANG_.call(null,"Git encountered an error; see console for details.");
return cljs.core.println.call(null,out);
});
lt.object.behavior_STAR_.call(null,new cljs.core.Keyword("lt.plugins.gibo.git","on-error","lt.plugins.gibo.git/on-error",2980156444),new cljs.core.Keyword(null,"triggers","triggers",2516997421),new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"proc.error","proc.error",4143512802),null], null), null),new cljs.core.Keyword(null,"reaction","reaction",4441361819),lt.plugins.gibo.git.__BEH__on_error);
lt.plugins.gibo.git.gh_default = lt.objs.files.join.call(null,lt.objs.files.home.call(null),".gitignore-boilerplates");
lt.plugins.gibo.git.gh_remote = "https://github.com/github/gitignore.git";
lt.plugins.gibo.git.__BEH__set_gh_local = (function __BEH__set_gh_local(this$,gh_custom){if(cljs.core.truth_(gh_custom))
{return lt.object.merge_BANG_.call(null,this$,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"gh-local","gh-local",3632269041),gh_custom], null));
} else
{return lt.object.merge_BANG_.call(null,this$,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"gh-local","gh-local",3632269041),lt.plugins.gibo.git.gh_default], null));
}
});
lt.object.behavior_STAR_.call(null,new cljs.core.Keyword("lt.plugins.gibo.git","set-gh-local","lt.plugins.gibo.git/set-gh-local",962280460),new cljs.core.Keyword(null,"desc","desc",1016984067),"gibo: set local github/gitignore repository",new cljs.core.Keyword(null,"params","params",4313443576),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"label","label",1116631654),"Absolute path",new cljs.core.Keyword(null,"type","type",1017479852),new cljs.core.Keyword(null,"string","string",4416885635)], null)], null),new cljs.core.Keyword(null,"type","type",1017479852),new cljs.core.Keyword(null,"user","user",1017503549),new cljs.core.Keyword(null,"triggers","triggers",2516997421),new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"object.instant","object.instant",773332388),null], null), null),new cljs.core.Keyword(null,"reaction","reaction",4441361819),lt.plugins.gibo.git.__BEH__set_gh_local);
/**
* @param {...*} var_args
*/
lt.plugins.gibo.git.__BEH__custom = (function() { 
var __BEH__custom__delegate = function (this$,paths){lt.object.merge_BANG_.call(null,this$,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"custom","custom",3959783139),cljs.core.set.call(null,paths)], null));
var temp__4126__auto__ = new cljs.core.Keyword(null,"selector","selector",2205476689).cljs$core$IFn$_invoke$arity$1(cljs.core.deref.call(null,lt.plugins.gibo.gibo));if(cljs.core.truth_(temp__4126__auto__))
{var selector = temp__4126__auto__;return lt.object.raise.call(null,selector,new cljs.core.Keyword(null,"force-refresh!","force-refresh!",3989490874));
} else
...
return __BEH__custom__delegate.call(this,this$,paths);};
__BEH__custom.cljs$lang$maxFixedArity = 1;
__BEH__custom.cljs$lang$applyTo = (function (arglist__7919){
var this$ = cljs.core.first(arglist__7919);
var paths = cljs.core.rest(arglist__7919);
return __BEH__custom__delegate(this$,paths);
});
__BEH__custom.cljs$core$IFn$_invoke$arity$variadic = __BEH__custom__delegate;
return __BEH__custom;
...
;
lt.object.behavior_STAR_.call(null,new cljs.core.Keyword("lt.plugins.gibo.git","custom","lt.plugins.gibo.git/custom",1512709749),new cljs.core.Keyword(null,"desc","desc",1016984067),"gibo: add custom local repositories",new cljs.core.Keyword(null,"params","params",4313443576),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"label","label",1116631654),"Absolute path",new cljs.core.Keyword(null,"type","type",1017479852),new cljs.core.Keyword(null,"string","string",4416885635)], null),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"label","label",1116631654),"& more",new cljs.core.Keyword(null,"type","type",1017479852),new cljs.core.Keyword(null,"string","string",4416885635)], null)], null),new cljs.core.Keyword(null,"type","type",1017479852),new cljs.core.Keyword(null,"user","user",1017503549),new cljs.core.Keyword(null,"triggers","triggers",2516997421),new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"object.instant","object.instant",773332388),null], null), null),new cljs.core.Keyword(null,"reaction","reaction",4441361819),lt.plugins.gibo.git.__BEH__custom);
lt.plugins.gibo.git.__BEH__prompt_for_clone = (function __BEH__prompt_for_clone(this$){return popup.popup_BANG_.call(null,new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"header","header",4087600639),"Gitignore boilerplates not found.",new cljs.core.Keyword(null,"body","body",1016933652),"To use gibo, you need a local copy of github/gitignore. Clone it now?",new cljs.core.Keyword(null,"buttons","buttons",1255256819),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"label","label",1116631654),"Clone github/gitignore",new cljs.core.Keyword(null,"action","action",3885920680),(function (){return lt.object.raise.call(null,this$,new cljs.core.Keyword(null,"create!","create!",2042458647),new cljs.core.Keyword(null,"gh-local","gh-local",3632269041).cljs$core$IFn$_invoke$arity$1(cljs.core.deref.call(null,this$)));
})], null),popup.cancel_button], null)], null));
});
lt.object.behavior_STAR_.call(null,new cljs.core.Keyword("lt.plugins.gibo.git","prompt-for-clone","lt.plugins.gibo.git/prompt-for-clone",4566324662),new cljs.core.Keyword(null,"triggers","triggers",2516997421),new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"clone?","clone?",3951346164),null], null), null),new cljs.core.Keyword(null,"reaction","reaction",4441361819),lt.plugins.gibo.git.__BEH__prompt_for_clone);
lt.plugins.gibo.git.__BEH__clone_gh_BANG_ = (function __BEH__clone_gh_BANG_(this$,local){lt.objs.notifos.working.call(null,[cljs.core.str("Cloning into "),cljs.core.str(local)].join(''));
return lt.objs.proc.exec.call(null,new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"command","command",1964298941),"git",new cljs.core.Keyword(null,"args","args",1016906831),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, ["clone",lt.plugins.gibo.git.gh_remote,local], null),new cljs.core.Keyword(null,"cwd","cwd",1014003170),lt.plugins.gibo.files.pwd.call(null),new cljs.core.Keyword(null,"env","env",1014004831),null,new cljs.core.Keyword(null,"obj","obj",1014014057),this$], null));
});
lt.object.behavior_STAR_.call(null,new cljs.core.Keyword("lt.plugins.gibo.git","clone-gh!","lt.plugins.gibo.git/clone-gh!",4515593718),new cljs.core.Keyword(null,"triggers","triggers",2516997421),new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"create!","create!",2042458647),null], null), null),new cljs.core.Keyword(null,"reaction","reaction",4441361819),lt.plugins.gibo.git.__BEH__clone_gh_BANG_);
lt.plugins.gibo.git.__BEH__pull_gh_BANG_ = (function __BEH__pull_gh_BANG_(this$){if(cljs.core.truth_(lt.plugins.gibo.files.git_QMARK_.call(null,new cljs.core.Keyword(null,"gh-local","gh-local",3632269041).cljs$core$IFn$_invoke$arity$1(cljs.core.deref.call(null,this$)))))
{lt.objs.notifos.working.call(null,[cljs.core.str("Updating "),cljs.core.str(new cljs.core.Keyword(null,"gh-local","gh-local",3632269041).cljs$core$IFn$_invoke$arity$1(cljs.core.deref.call(null,this$))),cljs.core.str(" to latest github/gitignore")].join(''));
return lt.objs.proc.exec.call(null,new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"command","command",1964298941),"git",new cljs.core.Keyword(null,"args","args",1016906831),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, ["pull","origin","master"], null),new cljs.core.Keyword(null,"cwd","cwd",1014003170),new cljs.core.Keyword(null,"gh-local","gh-local",3632269041).cljs$core$IFn$_invoke$arity$1(cljs.core.deref.call(null,this$)),new cljs.core.Keyword(null,"env","env",1014004831),null,new cljs.core.Keyword(null,"obj","obj",1014014057),this$], null));
} else
{return lt.object.raise.call(null,this$,new cljs.core.Keyword(null,"clone?","clone?",3951346164));
...
lt.object.behavior_STAR_.call(null,new cljs.core.Keyword("lt.plugins.gibo.git","pull-gh!","lt.plugins.gibo.git/pull-gh!",2276629214),new cljs.core.Keyword(null,"triggers","triggers",2516997421),new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"update!","update!",779473898),null], null), null),new cljs.core.Keyword(null,"reaction","reaction",4441361819),lt.plugins.gibo.git.__BEH__pull_gh_BANG_);
lt.object.object_STAR_.call(null,new cljs.core.Keyword("lt.plugins.gibo.git","repo","lt.plugins.gibo.git/repo",2840137332),new cljs.core.Keyword(null,"tags","tags",1017456523),new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"gibo-repo","gibo-repo",2140085570),null], null), null),new cljs.core.Keyword(null,"gh-local","gh-local",3632269041),lt.plugins.gibo.git.gh_default,new cljs.core.Keyword(null,"custom","custom",3959783139),cljs.core.PersistentHashSet.EMPTY,new cljs.core.Keyword(null,"init","init",1017141378),(function (this$){return null;
}));
}
