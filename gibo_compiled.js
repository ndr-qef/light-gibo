...
lt.plugins.gibo.local_bos = (function local_bos(r){return cljs.core.sort_by.call(null,(function (p1__7845_SHARP_){return clojure.string.lower_case.call(null,lt.plugins.gibo.bo_name.call(null,p1__7845_SHARP_));
...
return (function (p1__7847_SHARP_){return global.call(null,p1__7847_SHARP_);
});})(global))
,cljs.core.filter.call(null,((function (global){
return (function (p1__7846_SHARP_){return lt.objs.files.dir_QMARK_.call(null,global.call(null,p1__7846_SHARP_));
});})(global))
,p)))));
});
...
lt.plugins.gibo.__GT_bo = (function __GT_bo(coll){return cljs.core.map.call(null,(function (p1__7848_SHARP_){return cljs.core.PersistentHashMap.fromArrays.call(null,[new cljs.core.Keyword(null,"name","name",1017277949),new cljs.core.Keyword(null,"file","file",1017047278)],[lt.plugins.gibo.bo_name.call(null,p1__7848_SHARP_),p1__7848_SHARP_]);
}),coll);
});
...
lt.plugins.gibo.__BEH__on_exit = (function __BEH__on_exit(this$,data){var out = [cljs.core.str(data)].join('');var G__7851 = out;if(cljs.core._EQ_.call(null,"1",G__7851))
...
{if(cljs.core._EQ_.call(null,"0",G__7851))
...
lt.plugins.gibo.notify = (function notify(p){lt.objs.notifos.done_working.call(null,[cljs.core.str(".gitignore saved at "),cljs.core.str(p)].join(''));
return null;
});
...
return (function iter__7852(s__7853){return (new cljs.core.LazySeq(null,((function (opts__$1){
...
{var i = cljs.core._nth.call(null,c__7079__auto__,i__7854);cljs.core.chunk_append.call(null,b__7855,lt.objs.sidebar.command.item.call(null,this$,i));
{
var G__7867 = (i__7854 + 1);
i__7854 = G__7867;
continue;
}
} else
...
{var i = cljs.core.first.call(null,s__7853__$2);return cljs.core.cons.call(null,lt.objs.sidebar.command.item.call(null,this$,i),iter__7852.call(null,cljs.core.rest.call(null,s__7853__$2)));
}
} else
{return null;
}
...
lt.objs.command.command.call(null,new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"command","command",1964298941),new cljs.core.Keyword(null,"gibo.new","gibo.new",1742995283),new cljs.core.Keyword(null,"desc","desc",1016984067),"gibo: new gitignore",new cljs.core.Keyword(null,"options","options",4059396624),lt.plugins.gibo.gibo_list,new cljs.core.Keyword(null,"exec","exec",1017031683),(function (){return null;
})], null));
