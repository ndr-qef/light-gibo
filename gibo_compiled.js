...
var append__delegate = function (path,content,p__8578){var vec__8581 = p__8578;var cb = cljs.core.nth.call(null,vec__8581,0,null);try{lt.plugins.gibo.nfs.appendFileSync(path,content);
...
}catch (e8582){if((e8582 instanceof global.Error))
{var e = e8582;lt.object.raise.call(null,lt.objs.files.files_obj,new cljs.core.Keyword(null,"files.save.error","files.save.error",2424546720),path,e);
if(cljs.core.truth_(cb))
...
var p__8578 = null;if (arguments.length > 2) {
  p__8578 = cljs.core.array_seq(Array.prototype.slice.call(arguments, 2),0);} 
return append__delegate.call(this,path,content,p__8578);};
append.cljs$lang$maxFixedArity = 2;
append.cljs$lang$applyTo = (function (arglist__8591){
var path = cljs.core.first(arglist__8591);
arglist__8591 = cljs.core.next(arglist__8591);
var content = cljs.core.first(arglist__8591);
var p__8578 = cljs.core.rest(arglist__8591);
return append__delegate(path,content,p__8578);
});
...
lt.plugins.gibo.__GT_bo = (function __GT_bo(coll){return cljs.core.map.call(null,(function (p1__8583_SHARP_){return cljs.core.PersistentHashMap.fromArrays.call(null,[new cljs.core.Keyword(null,"name","name",1017277949),new cljs.core.Keyword(null,"file","file",1017047278)],[lt.plugins.gibo.bo_name.call(null,p1__8583_SHARP_),p1__8583_SHARP_]);
}),coll);
});
...
lt.plugins.gibo.__BEH__on_exit = (function __BEH__on_exit(this$,data){var out = [cljs.core.str(data)].join('');var G__8586 = out;if(cljs.core._EQ_.call(null,"1",G__8586))
...
{if(cljs.core._EQ_.call(null,"0",G__8586))
...
return (function iter__8587(s__8588){return (new cljs.core.LazySeq(null,((function (opts__$1){
return (function (){var s__8588__$1 = s__8588;while(true){
...
{var c__7452__auto__ = cljs.core.chunk_first.call(null,s__8588__$2);var size__7453__auto__ = cljs.core.count.call(null,c__7452__auto__);var b__8590 = cljs.core.chunk_buffer.call(null,size__7453__auto__);if((function (){var i__8589 = 0;while(true){
if((i__8589 < size__7453__auto__))
{var x = cljs.core._nth.call(null,c__7452__auto__,i__8589);cljs.core.chunk_append.call(null,b__8590,lt.objs.sidebar.command.item.call(null,this$,x));
{
var G__8592 = (i__8589 + 1);
i__8589 = G__8592;
continue;
}
} else
...
{var x = cljs.core.first.call(null,s__8588__$2);return cljs.core.cons.call(null,lt.objs.sidebar.command.item.call(null,this$,x),iter__8587.call(null,cljs.core.rest.call(null,s__8588__$2)));
}
} else
{return null;
}
